...
public class IABossThree : MonoBehaviour
{
    ...
    void PatrolState()
    {
        ...
        if (!SpawnBaiacu)
        {
            ...
            GameObject baiacu1 = Instantiate(Baiacu, Baiacu.transform.position = gameObject.transform.forward * 2, Baiacu.transform.rotation);
            GameObject baiacu2 = Instantiate(Baiacu, Baiacu.transform.position = gameObject.transform.forward * -2, Baiacu.transform.rotation);
            GameObject baiacu3 = Instantiate(Baiacu, Baiacu.transform.position = gameObject.transform.right * 2, Baiacu.transform.rotation);
            GameObject baiacu4 = Instantiate(Baiacu, Baiacu.transform.position = gameObject.transform.right * -2, Baiacu.transform.rotation);
